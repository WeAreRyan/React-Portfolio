...
export default function Projects() {
    ...
    <div className="row h-25 scrollbox">
        ...
        <div className="col-3">
            ...
            <a className="btn-project-link" target="_blank" href="https://weareryan.github.io/SEI-Project-1-Solitare/">Check It Out!</a>
            <a className="btn-project-link" target="_blank" href="https://github.com/WeAreRyan/SEI-Project-1-Solitare">Github Repo</a>
        ...
        <div className="col-3">
            ...
            <a className="btn-project-link" target="_blank" href="https://stardew-valley-tracker.herokuapp.com/">Check It Out!</a>
            <a className="btn-project-link" target="_blank" href="https://github.com/WeAreRyan/stardew-valley-completion-tracker">Github Repo</a>
        ...
        <div className="col-3">
            ...
            <a className="btn-project-link" target="_blank" href="https://macromanagerp3.herokuapp.com/">Check It Out!</a>
            <a className="btn-project-link" target="_blank" href="https://github.com/WeAreRyan/macromanager">Github Repo</a>
    ...
    <div className="col-1"></div>
        <div className="col-3">
            ...
            <a className="btn-project-link" target="_blank" href="https://rocks-r-us.herokuapp.com/">Check It Out!</a>
            <a className="btn-project-link" target="_blank" href="https://github.com/WeAreRyan/rocks-r-us">Github Repo</a>
